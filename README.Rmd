...
The plotting functions in fanplot are designed for working with graphics in base R. Jason Hilton has a  [ggfan](https://github.com/jasonhilton/ggfan) package which is great for creating fan charts in ggplot2.
